...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="wrap">
			...
			<div id="content">
				<div class="left"> 
					<h1>Welcome <s:property value="#session.Customer.getUsername()"/></h1>
				<div id="headingBlue">					
					...
					<h2>Your Details</h2>
						<p>UserName: <s:property value="#session.Customer.getUsername()"/></p>
						<p>First Name: <s:property value="#session.Customer.getFirstName()"/></p>
						<p>Last Name: <s:property value="#session.Customer.getLastName()"/></p>
						<p>Address: <s:property value="#session.Customer.getAddress()"/></p>
						<p>Age: <s:property value="#session.Customer.getAge()"/></p>
						<p>Payment Type: <s:property value="#session.Customer.getPaymentType()"/></p>+
						<s:url id="editCustomer" action="findCustomer">
								<s:param name="id" value="#session.Customer.getId()"></s:param>
							</s:url>
								<s:a href="%{editCustomer}">Edit</s:a>
